...
import com.refactech.driibo.type.dribble.DataSouce;
...
public class ShotsFragment extends BaseFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Item shot = mAdapter.getItem(position
	...
	private void loadData(final int page) {
		...
		executeRequest(new GsonRequest<DataSouce>(String.format(
				DribbbleApi.SHOTS_LIST, page), DataSouce.class,
				null, new Response.Listener<DataSouce>() {
					@Override
					public void onResponse(
							final DataSouce requestData) {
						CommonUtils
								.executeAsyncTask(new AsyncTask<Object, Object, Object>() {
									@Override
									protected Object doInBackground(
											Object... params) {
										mPage = requestData.page;
										if (mPage == 1) {
